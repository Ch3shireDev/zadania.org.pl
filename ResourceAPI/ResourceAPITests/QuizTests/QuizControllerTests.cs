    ...
    public class QuizControllerTests
    {
        ...
        public async Task<QuizAnswer> GetAnswer(int testId, int questionId, int answerId)
        {
            var res = await Client.GetAsync(
                $"/api/v1/quizzes/{testId}/questions/{questionId}/answers/{answerId}");
        ...
        {
            var res = await Client.GetAsync($"/api/v1/quizzes/{testId}/questions/{questionId}");
        ...
        {
            var res = await Client.GetAsync($"/api/v1/quizzes/{testId}");
        ...
        {
            var test = await Client.PostAsync("/api/v1/quizzes",
                new Quiz {Content = "abc", Name = "xyz"});
            var questionRes = await Client.PostAsync($"/api/v1/quizzes/{test.Id}/questions",
            ...
            var answer = await Client.PostAsync(
                $"/api/v1/quizzes/{test.Id}/questions/{question.Id}/answers",
        ...
        public async Task<QuizQuestion> CreateQuestion()
        {
            var test = await Client.PostAsync("/api/v1/quizzes",
                new Quiz {Content = "abc", Name = "xyz"});
            var question = await Client.PostAsync($"/api/v1/quizzes/{test.Id}/questions",
        ...
        public async void DeleteAnswer()
        {
            ...
            await Client.DeleteAsync(
                $"/api/v1/quizzes/{answer.TestId}/questions/{answer.QuestionId}/answers/{answer.Id}");
        ...
        public async void DeleteQuestion()
        {
            ...
            await Client.DeleteAsync($"/api/v1/quizzes/{question.TestId}/questions/{question.Id}");
        ...
        public async void DeleteTest()
        {
            ...
            Assert.NotNull(test);
            await Client.DeleteAsync($"/api/v1/quizzes/{test.Id}");
            var test1 = await GetTest(test.Id);
            Assert.Null(test1);
        }
        ...
        public async void EditQuestion()
        {
            var question = await CreateQuestion();
            Assert.NotNull(question);
            await Client.PutAsync($"/api/v1/quizzes/{question.TestId}/questions/{question.Id}",
                new QuizQuestion
                {
                    Content = "aaabbb"
                }.ToHttpContent());
        ...
        public async void EditTest()
        {
            var test = await CreateTest();
            Assert.NotNull(test);
            await Client.PutAsync($"/api/v1/quizzes/{test.Id}",
